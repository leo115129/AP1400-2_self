...
TEST(HW4Test, TEST2) {
    UniquePtr<int> ptr1{std::make_unique<int>(10)};
    EXPECT_EQ(*ptr1.get(), 10);

    UniquePtr<std::string> ptr2{std::make_unique<std::string>("hello world!")};
    EXPECT_EQ(*ptr2.get(), "hello world!");
}
...
TEST(HW4Test, TEST11) {
    SharedPtr<int> ptr1{std::make_shared<int>(10)};
    EXPECT_EQ(*ptr1.get(), 10);

    SharedPtr<std::string> ptr2{std::make_shared<std::string>("hello world!")};
    EXPECT_EQ(*ptr2.get(), "hello world!");
}
...
TEST(HW4Test, TEST14) {
    SharedPtr<std::string> ptr1{std::make_shared<std::string>("hello world!")};
